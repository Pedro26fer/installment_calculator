  ...
  return (
    <div className="App">
      <header className="App-header">
        <CenteredModal>
          <Form setDayOne={setOneDay} setDayTwo={setDayTwo} setDayThree={setDayThree} setDayFour={setDayFour}/>         

          <InstallmentInformation>
            <Notice dayOne={dayOne} dayTwo={dayTwo} dayThree={dayThree} dayFour={dayFour} />                     
          </InstallmentInformation>
